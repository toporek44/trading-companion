...
export const pages = ['dashboard','calendar','journal','plan','scanner','lessons','practice','glossary','milestones','brief'];
export const titles = {dashboard:'Dashboard', calendar:'Calendar', journal:'Trade Journal', plan:'Trading Plan', scanner:'Scanner', lessons:'Lessons', practice:'Practice', glossary:'Glossary', milestones:'Milestones', brief:'Daily Brief'};
