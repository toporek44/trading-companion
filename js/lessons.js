...
export const LESSONS = [
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: "Why does a merger/buyout catalyst NOT count toward the News pillar, even though it's real news?", options: ['Because mergers are rare', "Because once a buyout price is set, the stock's value is fixed and volatility dries up", "Because the data provider can't detect mergers", 'It does count — all news counts equally'], correct: 1, explain: "A fixed buyout price caps the stock's movement, removing exactly the volatility a momentum trade needs." },
